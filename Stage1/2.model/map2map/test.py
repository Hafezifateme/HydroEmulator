...
def test(args):
    ...
    with torch.no_grad():
        for i, (input, target) in enumerate(test_loader):
            ...
            print("n_output shape",output.shape)
            print("n_input shape",input.shape)
            print("n_target shape",target.shape)
            ...
            np.savez('./test/{}.npz'.format(i), input=input.numpy(),
